#!/usr/bin/env python3
"""p13_00_verify_inputs — verify SHA-256 of every frozen data asset before anything runs.
...
EXPECTED = {
 "data/P13_disclosure_coding.csv": None,   # filled from archive_manifest at build; verified below
}
