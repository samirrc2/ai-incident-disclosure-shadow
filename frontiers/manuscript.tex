...
\keyFont{ \section{Word count:} $\approx$7000 (main text, per Frontiers' definition); Figures: 4; Tables: 5 }
\end{abstract}
...
The authors declare that generative AI was used to assist with software scaffolding and coding of the analysis pipeline and with language editing and drafting of the manuscript, in all cases under the authors' direction. It was not used for the study design, data analysis, or interpretation of the results, and the authors take full responsibility for all content.

\section*{Acknowledgments}
Software scaffolding and coding of the analysis and verification pipeline were assisted by a large-language-model system under author validation; see the Generative AI Statement. The corresponding author is responsible for the accuracy of all content, citations, and references.
