...
\textbf{The AI Incident Disclosure Shadow: An Incident-Level Study Matching
AIID-Recorded AI Failures to U.S.-Listed Companies' Investor Disclosures,
2019--2026}\\[4pt]
...
The 40 incidents for which an external CSET AI Harm Taxonomy classification was
available. For these incidents the CSET severity classification was preserved
rather than assigned under the study rubric (see Materials and Methods,
``Severity of incidents''). CSET values are reproduced verbatim from the
released taxonomy; nothing is inferred. The remaining incidents were assigned
Severe/Moderate/Limited under the pre-specified study rubric and are not listed
here.

\vspace{6pt}

{\footnotesize
\begin{longtable}{@{}r p{9.2cm} l@{}}
\toprule
AIID incident ID & CSET classification (harm level; tangible harm) & Study severity \\
\midrule
\endfirsthead
\toprule
AIID incident ID & CSET classification (harm level; tangible harm) & Study severity \\
