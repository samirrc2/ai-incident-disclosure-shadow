...
FIG=ROOT/"revision"/"figures"; FIG.mkdir(parents=True,exist_ok=True)
...
# Note: AI-risk-language onset by issuer is presented as a table in the manuscript
# (Table 5), not a figure. Onset years are documented in the coding logs.
